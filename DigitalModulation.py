...
class DigitalModulation:
    ...
    def am_modulate(self,signal:np.ndarray, carrier_freq:int, sample_rate:int,
    ...
    def fm_modulate(self,signal:np.ndarray, carrier_freq:int, sample_rate:int,
    ...
    def ssb_modulate(self,signal:np.ndarray, carrier_freq:int, sample_rate:int,
